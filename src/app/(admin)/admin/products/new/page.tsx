            ...
            <Card>
              ...
              <CardContent className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2 sm:col-span-2">
                  ...
                  <Textarea value={form.images} onChange={e => updateForm("images", e.target.value)} placeholder="https://..." rows={2} />
                </div>
              </CardContent>
            </Card>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {variants.length === 0 && (
                  <p className="text-sm text-muted-foreground">No variants added. Click &quot;Add&quot; to create size/color variants.</p>
                )}
                {variants.map((v, i) => (
