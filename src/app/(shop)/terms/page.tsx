      ...
      <div className="mt-10 space-y-8 text-sm leading-relaxed text-muted-foreground">
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            and to cancel orders placed at incorrect prices. Prices are subject to
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            cancel orders for any reason, including suspected fraud.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            Please refer to our Returns & Refunds page for details on our return
            policy. Items must be returned within 30 days of delivery in their
            original condition.
          </p>
        </section>
